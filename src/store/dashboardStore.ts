...
export const useDashboardStore = create<DashboardState>((set, get) => ({
  ...
  contacts: [
    { id: '1', name: 'Natali Craig', avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612400e?w=40&h=40&fit=crop&crop=face', status: 'online' },
    { id: '2', name: 'Drew Cano', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=40&h=40&fit=crop&crop=face', status: 'offline' },
    { id: '3', name: 'Orlando Diggs', avatar: 'https://images.unsplash.com/photo-1517365830460-955ce3ccd263?w=40&h=40&fit=crop&crop=face', status: 'away' },
    { id: '4', name: 'Andi Lane', avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=40&h=40&fit=crop&crop=face', status: 'online' },
    { id: '5', name: 'Kate Morrison', avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=40&h=40&fit=crop&crop=face', status: 'offline' },
    { id: '6', name: 'Koray Okumus', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=40&h=40&fit=crop&crop=face', status: 'online' }
  ],
